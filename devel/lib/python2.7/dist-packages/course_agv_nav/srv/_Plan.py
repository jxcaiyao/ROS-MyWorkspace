...
"""autogenerated by genpy from course_agv_nav/PlanRequest.msg. Do not edit."""
import sys
...
class PlanRequest(genpy.Message):
  ...
  _type = "course_agv_nav/PlanRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from course_agv_nav/PlanResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class PlanResponse(genpy.Message):
  ...
  _type = "course_agv_nav/PlanResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """bool res
"""
  __slots__ = ['res']
